...
file_path = "./data/zhengwu_questions_2_1116.jsonl"
...
# # 答案要求
# 1.答案要完整，及时是文档中有的内容也不要省略，完整的表达出来
# 2.答案要准确，不要杜撰
...
if __name__ == "__main__":
    output_path = f"./data/answer/zhengwu_answer_2_1116.jsonl"
